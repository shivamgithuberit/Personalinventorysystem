<%-- 
    Document   : Income_Category_view1
    Created on : 7 Feb, 2023, 5:15:29 PM
    Author     : HP
--%>

<%@page import="com.personaliventorysystem.bean.IncomeCategoryBean"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.personaliventorysystem.dao.IncomeCategoryDAO"%>
        ...
        <div class="after_header">
            ...
            <form action="Add_IncomeCategory2">
                ...
                <table class="table1"  border="1" >
                    ...
                    <%
                        IncomeCategoryDAO ic = new IncomeCategoryDAO();

                        ArrayList<IncomeCategoryBean> al = ic.findAllData();
                        for (IncomeCategoryBean d : al) {
                    %>

                    <tr>
                       
                        <td><%=d.getInc_catname()%></td>
                        <td><%=d.getInc_catdetails()%></td>
                       
                        <td><button class="button"><a href="Edit_Income_Category.jsp?catid=<%=d.getInc_catid()%>">EDIT</a></button></td>
                        <td><button class="button"><a href="Delete_IncomeCategory?catid=<%=d.getInc_catid()%>">DELETE</a></button></td>


                    </tr>

                    <%
                        System.out.println(d.getInc_catid());
                        }
                    %>
                </table>
            </form>
