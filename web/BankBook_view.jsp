<%-- 
    Document   : View
    Created on : 4 Feb, 2023, 11:27:28 PM
    Author     : HP
--%>

<%@page import="com.personaliventorysystem.bean.BankBookBean"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.personaliventorysystem.dao.BankBookDAO"%>
            ...
            <form action="Add_IncomeCategory2">
                <table  border="0" cellspacing='0' class="table">
                    ...
                    <%
                        ...
                        ArrayList<BankBookBean> Ib = bd.findAllData();
                        for (BankBookBean e : Ib) {
