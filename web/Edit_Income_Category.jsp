<%-- 
    Document   : Edit_Income_Category
    Created on : 8 Feb, 2023, 4:09:05 AM
    Author     : HP
--%>
...
<html>
    ...
    <body style="background-color:#0099ff">
        ...
        <%
            int Userid = Integer.parseInt(request.getParameter("inc_catid"));
            IncomeCategoryDAO ud = new IncomeCategoryDAO();
            IncomeCategoryBean ub = ud.findByinc_catid(Userid);
        %>
        <div class="header" >
            <div class="leftside">
        ...
        <div class="after_header">
            ...
            <form action="Update_Income_Category">
                <div>
                    ...
                    <table  border="0" cellspacing='0' class="table"  >
                        ...
                        <tr>
                        <input type="hidden" name="catid"  value="<%= ub.getInc_catid() %>">
                            <td> <input type="hidden" name="userid" value="<%= ub.getUserid()%>">
                            </td>
                        </tr>
                        <tr>
                            <td>Category Name:</td>
                            <td> <input type="text" name="catname" value="<%=ub.getInc_catname() %>"></td>
                        </tr>

                        <tr>
                            <td>Category Details:</td>
                            <td> <input type="text" name="catdetails" value="<%=ub.getInc_catdetails() %>"></td>
                        </tr>
