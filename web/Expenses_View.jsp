<%-- 
    Document   : Expenses_View
    Created on : 8 Feb, 2023, 2:19:54 PM
    Author     : HP
--%>

<%@page import="com.personaliventorysystem.bean.ExpensesBean"%>
<%@page import="com.personaliventorysystem.dao.ExpensesDAO"%>
...
<html>
    ...
    <body style="background-color: #0099ff">
        <%
            ...
            ExpensesBean eb = ed.findByexp_id(Userid);
        %>
        <div class="header" >
            <div class="leftside">
            ...
            <form action="Add_Expenses">
                <div>
                    ...
                    <table  border="0" cellspacing='0' class="table"  >
                        ...
                        <tr>
                            <td > <input  type="hidden" name="userid"  value=<%=eb.getUserid()%> ></td>
                        </tr>
                        <tr>
                            <td>Expenses:</td>
                            <td> <input type="text" name="expenses" style="width: 200px;"></td>
                        </tr>

                        <tr>
                            <td>Category:</td>
                            <td> <input type="text" style="width: 200px;" name="category" value=<%=eb.getExp_ac()%>></td>
                        </tr>

                        <tr>
                            <td>Amount:</td>
                            <td> <input type="number" style="width: 200px;" name="amount" id="password" value=<%=eb.getAmount()%>></td>
                        </tr>          

                        <tr>
                            <td>Pay By :</td>
                            <td> <input type="radio"  name="payby" value=<%=eb.getPayby()%>>Cash <input type="radio" name="payby" value=<%=eb.getPayby()%>>Online <input type="radio" name="payby" value=<%=eb.getPayby()%>> Check</td>
                        </tr>

                        <tr>
                            <td>Date :</td>
                            <td> <input type="date"  style="width: 200px;" name="date" value=<%=eb.getTransaction_date()%>></td>
                        </tr>
                        <tr>
                            <td>Remark :</td>
                            <td> <input type="text" style="width: 200px;" name="remark" value=<%=eb.getRemark()%>></td>
                        </tr>
                        <tr>
                            <td><input type="submit" value="Add Expenses" style="width: 120px; height: 30px; color: gray;"></td>           
                        </tr>      
